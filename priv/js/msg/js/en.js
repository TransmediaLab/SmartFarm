...
Blockly.Msg.LSYSTEMS_CREATE_AXIOM = "with axiom";
Blockly.Msg.LSYSTEMS_CREATE_CONTAINER_TITLE_ADD = "L-System";
Blockly.Msg.LSYSTEMS_CREATE_CONTAINER_TOOLTIP = "Add or remove rule blocks to this L-System";
Blockly.Msg.LSYSTEMS_CREATE_EMPTY_TITLE = "and no rules";
Blockly.Msg.LSYSTEMS_CREATE_INPUT_WITH = "and with rules";
Blockly.Msg.LSYSTEMS_CREATE_ITEM_TITLE = "rule";
Blockly.Msg.LSYSTEMS_CREATE_ITEM_TOOLTIP = "Add a rule to the L-System";
Blockly.Msg.LSYSTEMS_CREATE_TITLE = "Create L-System";
Blockly.Msg.LSYSTEMS_CREATE_TOOLTIP = "Creates an L-System with provided axioms and rules";
Blockly.Msg.LSYSTEMS_DRAW_ANGLE = "angle";
Blockly.Msg.LSYSTEMS_DRAW_DISTANCE = "distance";
Blockly.Msg.LSYSTEMS_DRAW_RECURSIONS = "recursions";
Blockly.Msg.LSYSTEMS_DRAW_TITLE = "Draw L-System";
Blockly.Msg.LSYSTEMS_DRAW_TOOLTIP = "Draws an L-System using the provide angle, distance, and recursions";
Blockly.Msg.LSYSTEMS_DRAW_WITH = "with";
Blockly.Msg.LSYSTEMS_GET_HELPURL = "http://en.wikipedia.org/wiki/L-system";
Blockly.Msg.LSYSTEMS_RULE_TITLE = "Rule";
