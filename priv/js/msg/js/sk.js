...
Blockly.Msg.LSYSTEMS_CREATE_AXIOM = "with axiom";  // untranslated
Blockly.Msg.LSYSTEMS_CREATE_CONTAINER_TITLE_ADD = "L-System";  // untranslated
Blockly.Msg.LSYSTEMS_CREATE_CONTAINER_TOOLTIP = "Add or remove rule blocks to this L-System";  // untranslated
Blockly.Msg.LSYSTEMS_CREATE_EMPTY_TITLE = "and no rules";  // untranslated
Blockly.Msg.LSYSTEMS_CREATE_INPUT_WITH = "and with rules";  // untranslated
Blockly.Msg.LSYSTEMS_CREATE_ITEM_TITLE = "rule";  // untranslated
Blockly.Msg.LSYSTEMS_CREATE_ITEM_TOOLTIP = "Add a rule to the L-System";  // untranslated
Blockly.Msg.LSYSTEMS_CREATE_TITLE = "Create L-System";  // untranslated
Blockly.Msg.LSYSTEMS_CREATE_TOOLTIP = "Creates an L-System with provided axioms and rules";  // untranslated
Blockly.Msg.LSYSTEMS_DRAW_ANGLE = "angle";  // untranslated
Blockly.Msg.LSYSTEMS_DRAW_DISTANCE = "distance";  // untranslated
Blockly.Msg.LSYSTEMS_DRAW_RECURSIONS = "recursions";  // untranslated
Blockly.Msg.LSYSTEMS_DRAW_TITLE = "Draw L-System";  // untranslated
Blockly.Msg.LSYSTEMS_DRAW_TOOLTIP = "Draws an L-System using the provide angle, distance, and recursions";  // untranslated
Blockly.Msg.LSYSTEMS_DRAW_WITH = "with";  // untranslated
Blockly.Msg.LSYSTEMS_GET_HELPURL = "http://en.wikipedia.org/wiki/L-system";  // untranslated
Blockly.Msg.LSYSTEMS_RULE_TITLE = "Rule";  // untranslated
